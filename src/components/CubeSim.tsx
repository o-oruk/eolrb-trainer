...
// Replaces MUI's useMediaQuery(breakpoints.up('sm')) (>=600px) without pulling in MUI.
function useIsAtLeastSmall() {
    const [isSmall, setIsSmall] = React.useState(() => window.matchMedia('(min-width: 600px)').matches)
    useEffect(() => {
