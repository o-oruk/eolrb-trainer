...
import { FbdrSolver, SolverT, FsSolver, FsDrSolver, FsPseudoSolver, FELineP1Solver, SsSolver, SsDpSolver, SbSolver, FbSolver, FbSolverAtBL, FbSolverAtDL, FbssSolver, LpsbSolver, LSESolver, EOLRSolver, EOdMSolver, CenterSolver} from './Solver';

let all_solvers = [
"fbdr","fb", "fs-front", "fs-back", "ss-front", "ss-back",
